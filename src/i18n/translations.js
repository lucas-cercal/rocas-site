const pt = {
  ...
  contato: {
    ...
    form: {
      ...
      periodPlaceholder: "Ex.: 3 dias / mensal",
      messagePlaceholder:
  ...
  modal: {
    ...
    period: "Período / Detalhes",
    periodPlaceholder: "Descreva brevemente sua necessidade...",
...
const en = mergeDeep(pt, {
  ...
  contato: {
    ...
    form: {
      ...
      whatsappPlaceholder: "(00) 00000-0000",
      periodPlaceholder: "Example: 3 days / monthly",
  ...
  modal: {
    ...
    periodPlaceholder: "Briefly describe your need...",
...
const es = mergeDeep(pt, {
  ...
  contato: {
    ...
    form: {
      ...
      whatsappPlaceholder: "(00) 00000-0000",
      periodPlaceholder: "Ej.: 3 días / mensual",
  ...
  modal: {
    ...
    period: "Período / Detalles",
    periodPlaceholder: "Describe brevemente tu necesidad...",
...
const fr = mergeDeep(pt, {
  ...
  contato: {
    ...
    form: {
      ...
      whatsappPlaceholder: "(00) 00000-0000",
      periodPlaceholder: "Ex.: 3 jours / mensuel",
  ...
  modal: {
    ...
    periodPlaceholder: "Décrivez brièvement votre besoin...",
