    ...
    >
      <Reveal>
        <div style={{ maxWidth: 640, marginBottom: "2.6rem" }}>
          ...
          <p style={{ marginTop: ".95rem", fontSize: isMobile ? "16px" : "20px", color: "#4e6686", lineHeight: 1.8, fontWeight: 500, textAlign: "justify" }}>
            Relatos de clientes com rotinas de alta exigência, onde discrição e previsibilidade não são opcionais.
          </p>
        </div>
      </Reveal>
          ...
          {testimonials.map((item, index) => (
            ...
            >
              <div style={{ display: "flex", justifyContent: "flex-end", alignItems: "center", marginBottom: ".85rem" }}>
                <span style={{ fontSize: ".88rem", letterSpacing: ".1em", color: "#d4af37" }}>★★★★★</span>
              </div>

              <p style={{ fontSize: isMobile ? "16px" : "20px", color: lightSection.text, lineHeight: 1.8, fontWeight: 500, position: "relative", textAlign: "justify" }}>
                <span
                  style={{
                    position: "absolute",
                    left: "-.2rem",
